...
The distinction between them can be made extracting the information about the sign of the \(|00\dots0\rangle\) state at
...
evaluation algorithm in term of required operations.
Those improvements might be significant considering the limitation of today's quantum computers\cite{fawaz2019training}.

\section{Conclusion}\label{sec:conclusion}

In this work, we presented an enhanced QBNN evaluation method able to handle the outputs of a QBNN rapidly.
Besides, we reduced the QBNN execution cost by removing the amplitude amplification of the original method and introducing
a must efficient evaluation algorithm.
