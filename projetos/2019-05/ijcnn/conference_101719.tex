...
The experiments show that it was possible to reach an enhanced evaluation method. It is capable of yielding important information about hits and misses a specific quantum neural network architecture, quickly.
The information provided shows us the architecture that produces 100\% misses or 100\% hits.
The distinction between them can be made extracting the information about the sign of the \(|00\dots0\rangle\) state at the end of the circuit.
...
We reduced the number of used qubits from more than 14~\cite{fawaz2019training} to 12 and implemented a much less costly evaluation algorithm in term of required operations.
Those improvements might be important considering the limitation of today's quantum computers\cite{fawaz2019training}.

\section{Conclusion}\label{sec:conclusion}

  In this work, we presented a possible method to extract probabilistic information about the accuracy of the
